...
class UsersAdapter  : PagingDataAdapter<User,UsersAdapter.MyViewHolder>(DIFF_CALLBACK){
    ...
    class  MyViewHolder(private val binding: UserCardBinding) : RecyclerView.ViewHolder(binding.root) {
